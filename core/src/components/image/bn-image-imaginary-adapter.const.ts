...
type $StringParams<S> = S extends $Param
  ? S
  : S extends `${infer S1}|${infer S2}`
  ? $IsNever2<$StringParams<S1>, $StringParams<S2>>
  : never;
const toParamsFromStr = <S extends string>(str: $IsStringParams<S>) => toParams(str.split("|") as $StringParams<S>[]);
type $IsNever<T> = [T] extends [never] ? true : false;
type $IsNever2<T1, T2> = $IsNever<T1> extends true ? never : $IsNever<T2> extends true ? never : T1 | T2;
type $IsStringParams<S> = $IsNever<$StringParams<S>> extends true ? never : S;

const MODE_AND_PARAMS = nullProtoObj({
  crop: toParamsFromStr(
    "width|height|quality|compression|type|file|url|force|rotate|embed|norotation|noprofile|flip|flop|stripmeta|extend|background|colorspace|sigma|minampl|gravity|field|interlace|aspectratio",
  ),
  smartcrop: toParamsFromStr(
    "width|height|quality|compression|type|file|url|force|rotate|embed|norotation|noprofile|flip|flop|stripmeta|extend|background|colorspace|sigma|minampl|gravity|field|interlace|aspectratio",
  ),
  resize: toParamsFromStr(
    "width|height|quality|compression|type|file|url|embed|force|rotate|nocrop|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  extract: toParamsFromStr(
    "top|left|areawidth|areaheight|width|height|quality|compression|type|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  zoom: toParamsFromStr(
    "factor|width|height|quality|compression|type|file|url|embed|force|rotate|nocrop|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  thumbnail: toParamsFromStr(
    "width|height|quality|compression|type|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  fit: toParamsFromStr(
    "width|height|quality|compression|type|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  rotate: toParamsFromStr(
    "rotate|width|height|quality|compression|type|file|url|embed|force|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  autorotate: toParamsFromStr(
    "rotate|width|height|quality|compression|type|file|url|embed|force|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  flip: toParamsFromStr(
    "width|height|quality|compression|type|file|url|embed|force|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  flop: toParamsFromStr(
    "width|height|quality|compression|type|file|url|embed|force|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  convert: toParamsFromStr(
    "type|quality|compression|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|aspectratio|palette",
  ),
  watermark: toParamsFromStr(
    "text|margin|dpi|textwidth|opacity|noreplicate|font|color|quality|compression|type|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|palette",
  ),
  watermarkimage: toParamsFromStr(
    "image|top|left|opacity|quality|compression|type|file|url|embed|force|rotate|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|sigma|minampl|field|interlace|palette",
  ),
  blur: toParamsFromStr(
    "sigma|minampl|width|height|quality|compression|type|file|url|embed|force|norotation|noprofile|stripmeta|flip|flop|extend|background|colorspace|field|interlace|aspectratio|palette",
  ),
  /**管道，聚合 */
  pipeline: toParamsFromStr("operations|file|url"),
} as const);
