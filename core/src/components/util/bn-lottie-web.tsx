...
import { forceGetLottieToggleButtonColors } from "./bn-lottie-web-toggle-button.const";
...
@Component({
  tag: "bn-lottie-web",
  styleUrl: "bn-lottie-web.scss",
  shadow: true,
})
export class BnLottieWeb implements ComponentInterface {
